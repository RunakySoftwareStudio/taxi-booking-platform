...
export const tableStyles = {
    ...
    cellCheckBoxTextGreen:    "ml-2 rounded-full bg-green-600/25 px-2 py-1 text-xs font-semibold text-green-100 ring-1 ring-green-500/40",
    cellCheckBoxTextRed:      "ml-2 rounded-full bg-red-600/25 px-2 py-1 text-xs font-semibold text-red-100 ring-1 ring-red-500/40",
