...
export const pageStyles = {
  ...
  smallContainer:           "mx-auto max-w-4xl",
...
export const tableStyles = {
  ...
  tableDiv:                 "mt-10 overflow-x-auto rounded-2xl border border-cyan-400/30 bg-white/5",
  tableWide:                "w-full min-w-[1200px] text-left text-sm",
  header:                   "border-b border-white/10 bg-white/10 text-slate-300",
  headerCyan:               "border-b border-cyan-400/30 bg-cyan-400/10 text-slate-300",
