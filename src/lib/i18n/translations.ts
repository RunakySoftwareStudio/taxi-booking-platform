...
export const translations = {
  ...
  chauffeurAvailabilityPage: {
	...
	titlePrefix: {
		en: "Manage unavailable times for",
		nl: "Beheer niet-beschikbare tijden voor",
		ar: "إدارة أوقات عدم التوفر لـ",
		tr: "Uygun olunmayan zamanları yönetin:",
		fa: "مدیریت زمان‌های عدم دسترسی برای",
	},
	description: {
		en: "Add vacations, absence days or hours when you cannot work. Booking times are added automatically.",
		nl: "Voeg vakanties, afwezigheidsdagen of uren toe waarop je niet kunt werken. Boekingstijden worden automatisch toegevoegd.",
		ar: "أضف الإجازات أو أيام الغياب أو الساعات التي لا يمكنك العمل فيها. تتم إضافة أوقات الحجوزات تلقائيًا.",
		tr: "Çalışamayacağınız tatil, izin günü veya saatleri ekleyin. Rezervasyon saatleri otomatik olarak eklenir.",
		fa: "تعطیلات، روزهای غیبت یا ساعت‌هایی را که نمی‌توانید کار کنید اضافه کنید. زمان رزروها به‌صورت خودکار اضافه می‌شود.",
	},
	...
	availabilityTitle: {
		en: "Unavailable times",
		nl: "Niet-beschikbare tijden",
		ar: "أوقات عدم التوفر",
		tr: "Uygun olunmayan zamanlar",
		fa: "زمان‌های عدم دسترسی",
	},
	addedSuccess: {
    en: "Unavailable time added successfully.",
    nl: "Niet-beschikbare tijd is succesvol toegevoegd.",
    ar: "تمت إضافة وقت عدم التوفر بنجاح.",
    tr: "Uygun olunmayan zaman başarıyla eklendi.",
    fa: "زمان عدم دسترسی با موفقیت اضافه شد.",
	},
	deletedSuccess: {
		en: "Unavailable time deleted successfully.",
		nl: "Niet-beschikbare tijd is succesvol verwijderd.",
		ar: "تم حذف وقت عدم التوفر بنجاح.",
		tr: "Uygun olunmayan zaman başarıyla silindi.",
		fa: "زمان عدم دسترسی با موفقیت حذف شد.",
	},
    missingFieldsError: {
	...
	addAvailabilityButton: {
		en: "Add unavailable time",
		nl: "Niet-beschikbare tijd toevoegen",
		ar: "إضافة وقت عدم توفر",
		tr: "Uygun olunmayan zaman ekle",
		fa: "افزودن زمان عدم دسترسی",
	},
	recordsTitle: {
		en: "Unavailable and booked times",
		nl: "Niet-beschikbare en geboekte tijden",
		ar: "أوقات عدم التوفر والحجوزات",
		tr: "Uygun olunmayan ve rezerve edilmiş zamanlar",
		fa: "زمان‌های عدم دسترسی و رزروشده",
	},
    editButton: {
      en: "Edit",
      nl: "Bewerken",
	...
	noRecordsMessage: {
		en: "No unavailable or booked times found.",
		nl: "Geen niet-beschikbare of geboekte tijden gevonden.",
		ar: "لم يتم العثور على أوقات عدم توفر أو حجوزات.",
		tr: "Uygun olunmayan veya rezerve edilmiş zaman bulunamadı.",
		fa: "هیچ زمان عدم دسترسی یا رزروشده‌ای پیدا نشد.",
	},
    statusAvailable: {
      en: "Available",
      nl: "Beschikbaar",
    ...
    bookingBusyPeriodReadOnly: {
        en: "Created automatically from a booking.",
        nl: "Automatisch aangemaakt vanuit een boeking.",
        ar: "تم إنشاؤها تلقائيًا من حجز.",
        tr: "Bir rezervasyondan otomatik olarak oluşturuldu.",
        fa: "این بازه به‌صورت خودکار از یک رزرو ایجاد شده است.",
    },

    bookingPeriodProtectedError: {
        en: "This busy period belongs to a booking and cannot be deleted manually.",
        nl: "Deze bezette periode hoort bij een boeking en kan niet handmatig worden verwijderd.",
        ar: "ترتبط هذه الفترة المشغولة بحجز ولا يمكن حذفها يدويًا.",
        tr: "Bu yoğun dönem bir rezervasyona bağlıdır ve manuel olarak silinemez.",
        fa: "این بازه مشغول به یک رزرو مرتبط است و نمی‌توان آن را به‌صورت دستی حذف کرد.",
    },
  },
 ...
 // Text used by the chauffeur self-management profile page.
  ...
  chauffeurDashboardPage: {
    ...
    passengerSupportTitle: {
    en: "Passenger support",
    nl: "Passagiersvoorzieningen",
    ar: "تجهيزات دعم الركاب",
    tr: "Yolcu desteği",
    fa: "امکانات پشتیبانی مسافر",
    },
    infantSeatsLabel: {
        en: "Infant seats",
        nl: "Babyzitjes",
    ...
    boosterSeatsLabel: {
        ...
        nl: "Zitverhogers",
        ar: "المقاعد المعززة",
        tr: "Yükseltici koltuklar",
        fa: "صندلی تقویتی کودک",
    },
    isofixLabel: {
        en: "ISOFIX",
        nl: "ISOFIX",
    ...
    wheelchairAccessLabel: {
        ...
        nl: "Rolstoeltoegang",
        ar: "إمكانية دخول الكرسي المتحرك",
        tr: "Tekerlekli sandalye erişimi",
        fa: "دسترسی ویلچر",
    },
    wheelchairCapacityLabel: {
        en: "Wheelchair capacity",
        nl: "Rolstoelcapaciteit",
        ar: "سعة الكراسي المتحركة",
        tr: "Tekerlekli sandalye kapasitesi",
        fa: "ظرفیت ویلچر",
    },
    mobilityAidStorageLabel: {
        en: "Mobility-aid storage",
        nl: "Ruimte voor mobiliteitshulpmiddelen",
        ar: "مساحة لتخزين وسائل المساعدة على الحركة",
        tr: "Hareket yardımcısı depolama alanı",
        fa: "فضای وسایل کمک‌حرکتی",
    },
    extraLargeLuggageLabel: {
        en: "Extra-large luggage",
        nl: "Extra grote bagage",
        ar: "أمتعة كبيرة جدًا",
        tr: "Ekstra büyük bagaj",
        fa: "بار بسیار بزرگ",
    },
    wheelchairNone: {
        en: "None",
    ...
    wheelchairFoldableOnly: {
        en: "Foldable wheelchair only",
        nl: "Alleen opvouwbare rolstoel",
        ar: "كرسي متحرك قابل للطي فقط",
        tr: "Yalnızca katlanabilir tekerlekli sandalye",
        fa: "فقط ویلچر تاشو",
    },
    wheelchairRamp: {
        en: "Ramp",
